...
class LecturerRegister(BaseModel):
    ...
    title: str = Field(
        ...,
        description="Lecturer | Senior Lecturer | Professor | Assistant Lecturer",
    )
...
class OrganizationRegister(BaseModel):
    ...
    organization_type: str = Field(
        ..., description="Company | NGO | Government | Institution",
    )
    industry: str = Field(
        ..., description="Technology | Education | Healthcare | ...",
    )
...
class MentorRegister(BaseModel):
    ...
    availability: str = Field(
        ..., description="Weekdays | Weekends | Evenings | Flexible",
    )
    tos_accepted: bool = Field(...)
    privacy_accepted: bool = Field(...)
    tos_version: str | None = Field("1.0", max_length=32)
